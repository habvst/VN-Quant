...
const RAW_STOCKS: RawStockSeed[] = [
  ...
  // --- HNX MIDCAPS TIỀM NĂNG ---
  {
    ...
    profitGrowthYoY: 54.0,
    dividendYield: 4.5,
    aiVerdict: 'MUA MẠNH',
    aiScore: 91,
    aiTarget: 17.5,
    aiStop: 12.2,
    aiReasoning: 'Thanh khoản đứng top sàn HNX, hưởng lợi trực tiếp từ chu kỳ bùng nổ thanh khoản toàn thị trường. Định giá P/B dưới 1.0x mở ra biên an toàn lớn.',
  },
  {
    symbol: 'IDC',
    ...
    aiTarget: 68.0,
    aiStop: 50.0,
    aiReasoning: 'Quỹ đất KCN cho thuê sẵn sàng lớn tại Hựu Thạnh, Phú Mỹ 2 và Cầu Nghìn. Dòng tiền cổ tức tiền mặt đều đặn 30-40% hàng năm.',
  },
  {
    symbol: 'MBS',
    ...
    aiTarget: 32.0,
    aiStop: 23.5,
    aiReasoning: 'Thị phần môi giới bứt phá mạnh mẽ nhờ hệ sinh thái ngân hàng mẹ MBB. Tăng vốn thành công mở rộng dư địa cho vay margin.',
  },
  {
    symbol: 'CEO',
    ...
    aiTarget: 18.8,
    aiStop: 13.8,
    aiReasoning: 'Dự án Sonasea Vân Đồn Harbor City tiếp tục bàn giao phân khu shophouse. Cấu trúc tài chính sạch gần như không có nợ vay ngân hàng.',
  },
  {
    symbol: 'VCS',
    ...
    aiTarget: 65.0,
    aiStop: 48.0,
    aiReasoning: 'Thị trường bất động sản Bắc Mỹ ấm lại thúc đẩy đơn hàng xuất khẩu đá thạch anh nhân tạo cao cấp. Tỷ lệ trả cổ tức tiền mặt duy trì 40-60%.',
  },
  {
    symbol: 'TNG',
    ...
    aiTarget: 27.5,
    aiStop: 20.0,
    aiReasoning: 'Đơn hàng xuất khẩu may mặc sang thị trường Mỹ và EU đã kín đến hết quý 3. Biên lợi nhuận cải thiện nhờ tỷ lệ tự động hóa nhà máy cao.',
  },

  // --- UPCOM TIỀM NĂNG & BLUECHIPS ---
  {
    symbol: 'BSR',
    ...
    netMargin: 6.1,
    revenueGrowthYoY: 18.0,
    profitGrowthYoY: 26.0,
    dividendYield: 4.8,
    aiVerdict: 'MUA MẠNH',
    aiScore: 92,
    aiTarget: 26.8,
    aiStop: 19.2,
    aiReasoning: 'Crack spread xăng dầu khu vực châu Á duy trì tích cực. Kế hoạch chuyển sàn sang HOSE là động lực tái định giá cổ phiếu mạnh mẽ.',
  },
  {
    symbol: 'VEA',
    name: 'Tổng Công ty Máy động lực và máy nông nghiệp Việt Nam',
    exchange: 'UPCOM',
    ...
    profitGrowthYoY: 15.0,
    dividendYield: 11.5,
    aiVerdict: 'MUA MẠNH',
    aiScore: 94,
    aiTarget: 51.0,
    aiStop: 38.0,
    aiReasoning: 'Cỗ máy in tiền mặt từ liên doanh Toyota, Honda và Ford Việt Nam. Lợi tức cổ tức tiền mặt lên đến 11-12%/năm, an toàn tuyệt đối.',
  },
  {
    symbol: 'ACV',
    ...
    netMargin: 35.0,
    revenueGrowthYoY: 22.0,
    profitGrowthYoY: 34.0,
    dividendYield: 0.0,
    aiVerdict: 'MUA MẠNH',
    aiScore: 90,
    aiTarget: 135.0,
    aiStop: 98.0,
    aiReasoning: 'Vị thế độc quyền khai thác toàn bộ các cảng hàng không dân dụng tại Việt Nam. Dự án đại sân bay Long Thành giai đoạn 1 bước vào giai đoạn về đích.',
  },
  {
    symbol: 'QNS',
    ...
    aiTarget: 58.0,
    aiStop: 43.0,
    aiReasoning: 'Chiếm hơn 80% thị phần sữa đậu nành hộp giấy (Fami) và hưởng lợi lớn từ giá đường nội địa neo cao nhờ chính sách phòng vệ thương mại.',
  },
  {
    symbol: 'VGI',
    name: 'Tổng Công ty Cổ phần Đầu tư Quốc tế Viettel - Viettel Global',
    exchange: 'UPCOM',
    sector: 'Công nghệ',
    basePrice: 85.0,
    referencePrice: 83.5,
    ...
    aiTarget: 105.0,
    aiStop: 75.0,
    aiReasoning: 'Doanh thu dịch vụ viễn thông tại các thị trường quốc tế (Đông Nam Á, Châu Phi, Mỹ La-tinh) tăng tốc mạnh cùng dòng tiền chuyển về nước dồi dào.',
  },
  {
    symbol: 'MCH',
    ...
    profitGrowthYoY: 20.5,
    dividendYield: 4.5,
    aiVerdict: 'MUA MẠNH',
    aiScore: 93,
    aiTarget: 235.0,
    aiStop: 178.0,
    aiReasoning: 'Cỗ máy tăng trưởng của tập đoàn Masan với các thương hiệu quốc dân Chin-Su, Nam Ngư, Omachi. Đang tiến hành lộ trình niêm yết lên sàn HOSE.',
  },

  // --- HOSE MIDCAPS BỔ SUNG ---
  {
    symbol: 'ANV',
    ...
    aiTarget: 38.5,
    aiStop: 28.0,
    aiReasoning: 'Tự chủ 100% con giống và thức ăn thủy sản giúp tối ưu giá thành cá tra xuất khẩu. Đơn hàng sang Trung Quốc và Mỹ hồi phục rõ nét.',
  },
  {
    symbol: 'HAH',
    ...
    aiTarget: 52.0,
    aiStop: 37.5,
    aiReasoning: 'Đội tàu container lớn nhất Việt Nam liên tục nhận bàn giao tàu mới tải trọng lớn. Giá cước vận tải biển nội địa và nội Á tăng mạnh.',
  },
  {
    symbol: 'DCM',
    ...
    aiTarget: 43.0,
    aiStop: 32.5,
    aiReasoning: 'Nhà máy đạm hết khấu hao hoàn toàn giúp tiết giảm hàng trăm tỷ chi phí mỗi năm. Mở rộng thành công mảng phân bón NPK và xuất khẩu sang Ấn Độ.',
  },
  {
    symbol: 'PC1',
    name: 'Công ty Cổ phần Tập đoàn PC1',
    exchange: 'HOSE',
    sector: 'Điện',
    basePrice: 26.8,
    referencePrice: 26.2,
    ...
    aiTarget: 33.0,
    aiStop: 24.0,
    aiReasoning: 'Doanh nghiệp dẫn đầu về xây lắp đường dây và trạm biến áp 500kV mạch 3. Khai thác thương mại mỏ Niken - Đồng đem lại lợi nhuận đột biến.',
  },
  {
    symbol: 'VCI',
    ...
    aiTarget: 42.0,
    aiStop: 30.5,
    aiReasoning: 'Vị thế thống trị mảng tư vấn ngân hàng đầu tư (IB) với chuỗi thương vụ thoái vốn và IPO lớn. Danh mục tự doanh cổ phiếu chất lượng cao tăng trưởng mạnh.',
  },
];
  ...
  try {
    ...
    if (res.ok) {
      ...
      if (Array.isArray(data) && data.length > 0) {
        ...
        const changePercent = ref > 0 ? Number(((change / ref) * 100).toFixed(2)) : (Number(item.changePc) || 0);
