  ...
  return (
    <div className="p-4 bg-[#050505] text-[#d1d5db] min-h-screen space-y-4 font-mono">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 font-mono text-xs">
        ...
        <div className="bg-[#0a0a0a] p-3 rounded-sm border border-gray-800 shadow">
          <span className="text-gray-500 text-[10px] uppercase block">LÃI / LỖ ĐÃ THỰC HIỆN</span>
          <span className={`font-bold text-sm ${totalRealizedPnL >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
            {totalRealizedPnL >= 0 ? '+' : ''}
            {totalRealizedPnL.toLocaleString('vi-VN')}
          </span>
          <span className="text-gray-500 text-[10px] block">Từ các giao dịch bán</span>
        </div>
            ...
            <table className="w-full text-xs font-mono text-left">
              <thead className="bg-[#050505] text-gray-400 border-b border-gray-800 uppercase text-[10px] tracking-wider">
                <tr>
                  ...
                  <th className="p-3 text-center">Hành Động Bán</th>
