  ...
  return (
    <header className="bg-[#0a0a0a] border-b border-gray-800 text-[#d1d5db] sticky top-0 z-50 shadow-2xl">
      ...
      <div className="flex items-center gap-3 px-3 py-1.5 w-full">
        ...
        <div className="h-8 w-px bg-gray-800 hidden sm:block shrink-0"></div>
        ...
        <div className="h-8 w-px bg-gray-800 hidden md:block shrink-0"></div>

        {/* Nav Tabs in 2 clean rows directly to the right of Selected Stock Box */}
        <nav className="flex flex-col justify-center gap-1 min-w-0 flex-1 overflow-x-auto scrollbar-none py-0.5">
          {/* Row 1 */}
            ...
            {navItems.slice(0, 5).map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center space-x-1 px-2 py-1 rounded-sm text-[11px] font-mono transition whitespace-nowrap border cursor-pointer ${
                    isActive
                ...
                >
                  ...
                  {item.badge && (
                    <span
                      className={`text-[8px] px-1 py-0.2 rounded-sm font-bold uppercase font-mono ${
                        item.badge === 'HOT'
